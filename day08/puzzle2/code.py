...
..........''',
        ...
        'num_unique_harmonic_antinode_locations': 5
    },
    {
        'input': '''\
T....#....
...
..........''',
        'num_antennas': 3,
        'num_unique_antinode_locations': 3,
        'num_unique_harmonic_antinode_locations': 9
    },
    {
        'input': '''\
............
...
............''',
        ...
        'num_unique_harmonic_antinode_locations': 34
    },
    {
...
attrs = [
    ...
    'num_unique_harmonic_antinode_locations',
    ]
...
def solve( case ):
    ...
    valid_harmonic_antinode_locations = set()
    ...
    for frequency, antenna_locations in antenna_locations_by_frequency_char.items():
        for i in range(len(antenna_locations)):
            for j in range(i+1, len(antenna_locations)):
                ...
                x = location_j[0]
                y = location_j[1]
                while check_coord_in_bounds( (x,y) ):
                    valid_harmonic_antinode_locations.add( (x,y) )
                    x += delta_x
                    y += delta_y
    ...
    num_unique_harmonic_antinode_locations = len(valid_harmonic_antinode_locations)

    return {
        'num_antennas': num_antennas,
        'num_unique_antinode_locations': num_unique_antinode_locations,
        'num_unique_harmonic_antinode_locations': num_unique_harmonic_antinode_locations
    }
...
# AOC 2024: 2024-12-16: day08/puzzle2/..
# [{'num_unique_harmonic_antinode_locations': 1293, 'elapsed_time_s': 0.000926624983549118}]